...
namespace galaxy_v36
{
	namespace game
	{
		...
		public:
			...
			virtual void removeHandler(Command* command, CommandHandler* handler) = 0;
			virtual void removeHandler(const std::string& commandName, CommandHandler* handler) = 0;
			virtual void removeAllHandlers(const std::string& commandName) = 0;
